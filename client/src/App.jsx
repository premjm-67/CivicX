  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <Routes>
        ...
        <Route path="/department" element={<ProtectedRoute roles={['department_admin']}><DepartmentDashboardPage /></ProtectedRoute>} />
        <Route path="/worker" element={<ProtectedRoute roles={['worker']}><WorkerDashboardPage /></ProtectedRoute>} />
        <Route path="/admin-live" element={<ProtectedRoute roles={['admin']}><AdminLiveTrackingPage /></ProtectedRoute>} />
        <Route path="/worker-live" element={<ProtectedRoute roles={['worker']}><WorkerLiveTrackingPage /></ProtectedRoute>} />
        <Route path="/complaint/:id" element={<ProtectedRoute roles={['admin', 'department_admin', 'worker']}><ComplaintDetailPage /></ProtectedRoute>} />
